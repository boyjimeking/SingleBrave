...
public class CMath
{
    ...
    /// <param name="stSWidth"></param>
    /// <param name="stSHeight"></param>
    /// <param name="now_width"></param>
    /// <param name="now_height"></param>
    public static Rect PosToScreen(Rect rect, int stSWidth, int stSHeight, int now_width, int now_height)
    {
        //Debug.Log(stSWidth + " - " + stSHeight);
        //Debug.Log(now_width + " - " + now_height);
    ...
    public static Vector3 Curve(Vector3 start, Vector3 end , float heigh , float rate )
    {
        ...
        //float rate = disTime / costTime;
        Vector3 pos = Vector3.Lerp(start, end, rate);
        //float rate1 = disTime / (costTime / 2f);
        float rate1 = rate*2f;
