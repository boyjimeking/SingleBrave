...
/// 活动战斗失败应答
/// </summary>
public class ActivityBattleFailPktAck : HTTPPacketBase
{
    ...
    public ActivityBattleFailPktAck()
    {
...
/// 活动战斗应答工厂类
/// </summary>
public class ActivityBattleFailPktAckFactory : HTTPPacketFactory
{
    public ActivityBattleFailPktAckFactory()
    {
        //
    }
    ...
    {
        ActivityBattleFailPktAck ack = PACKET_HEAD.PACKET_ACK_HEAD<ActivityBattleFailPktAck>(json);
        ...
        for (int i = 0; i < update_item.Count; i++)
        {
            ...
            ActivityBattleFailPktAck.ItemData itemData = new ActivityBattleFailPktAck.ItemData();
            itemData.Parse(item);
