...
namespace Game.Gfx
{
    ...
    public class DieState : StateBase
    {
        ...
        public override bool OnEnter()
        {
            ...
            this.m_cStartScale = this.m_cObj.GetLocalScale();
            this.m_cStartPos = this.m_cObj.GetLocalPos();
        ...
        public override bool Update()
        {
            ...
            {
                this.m_cObj.SetLocalScale(Vector3.zero);
                return false;
            }
            ...
            this.m_cObj.SetLocalScale(scale);
