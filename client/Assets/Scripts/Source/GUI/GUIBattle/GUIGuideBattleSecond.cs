...
public class GUIGuideBattleSecond : GUIBattle
{
    ...
    public override void Show()
    {
        ...
        //背景音乐
		MediaMgr.sInstance.PlayBGM("SD_BGM15混");
//        MediaMgr.PlayBGM("SD_BGM15混");
    ...
    private void BattleFinish()
    {
        ...
        if (this.m_iMaxLayer <= this.m_iCurLayer)
        {
            ...
            GUIDE_FUNCTION.SHOW_STORY(GUIDE_FUNCTION.STORY_FIRST_FIGHT_END1, StoryFinishCallBack);
...
//        MediaMgr.PlayBGM(SOUND_DEFINE.BGM_MAIN);
    ...
    {
        GUIDE_FUNCTION.SHOW_STORY(GUIDE_FUNCTION.STORY_SECOND_FIGHT_END, StoryFinishCallBack2);
    }
