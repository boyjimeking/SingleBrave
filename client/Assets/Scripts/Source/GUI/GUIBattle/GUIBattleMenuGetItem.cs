...
public class GUIBattleMenuGetItem : GUIBase
{
    ...
    public override void Show()
    {
        ...
        if (this.m_cGUIObject == null)
        {
            ...
            ResourcesManager.GetInstance().LoadResource(GAME_DEFINE.RESOURCE_GUI_PATH, RES_GETITEM);
        }
        else
        {
            InitGUI();
    ...
    protected override void InitGUI()
    {
        ...
        if (this.m_cGUIObject == null)
        {
            ...
            this.m_cGetPropsItem = (UnityEngine.Object)ResourcesManager.GetInstance().Load(RES_GETITEM);
    ...
    public override void Hiden()
    {
        ...
        ResourcesManager.GetInstance().UnloadResource(RES_GETITEM);
        Destory();
    }
