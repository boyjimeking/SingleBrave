...
/// 原地攻击命令
/// </summary>
public class CmdAttackState : CmdStateBase
{
    ...
    public CmdAttackState(BattleHero hero, IGUIBattle gui)
        : base(hero, gui)
    {
    ...
    public void Set(BattleHero target)
    {
    ...
    public override bool Update()
    {
        ...
        //结束判定
        if (this.m_cControl.GetCurrentState().GetStateType() != STATE_TYPE.STATE_ATTACK && this.m_iStep == 0)
        {
            //判定击中伤害结束
            bool finish = true;
